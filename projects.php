...
//  }
$id=$_GET['slug'];
$datashowquery="SELECT * FROM `projects` WHERE slug='$id' ";
...
<head>
    ...
    <meta property="og:title" content="<?php echo $show['meta_title'] ?>">
    <meta property="og:description" content="<?php echo $show['meta_desc'] ?>">
...
<img src="https://www.allyproperties.pk/admin-panel/pages/project/<?php echo $show['feature_img1'] ?>" style="margin: auto; width:60px; height:60px; margin-bottom: 5px;" alt="">
<h4>
<?php echo $show['feature_title1'] ?></h4>
        </div>
        <div class="col-md-4 col-6 text-center my-4">
<img src="https://www.allyproperties.pk/admin-panel/pages/project/<?php echo $show['feature_img2'] ?>" style="margin: auto; width:60px; height:60px; margin-bottom: 5px;" alt="">
<h4>
<?php echo $show['feature_title2'] ?></h4>
        </div>
        <div class="col-md-4 col-6 text-center my-4">
<img src="https://www.allyproperties.pk/admin-panel/pages/project/<?php echo $show['feature_img3'] ?>" style="margin: auto; width:60px; height:60px; margin-bottom: 5px;" alt="">
<h4>
<?php echo $show['feature_title3'] ?></h4>
        </div>
        <div class="col-md-4 col-6 text-center my-4">
<img src="https://www.allyproperties.pk/admin-panel/pages/project/<?php echo $show['feature_img4'] ?>" style="margin: auto; width:60px; height:60px; margin-bottom: 5px;" alt="">
<h4>
<?php echo $show['feature_title4'] ?></h4>
        </div>
        <div class="col-md-4 col-6 text-center my-4">
<img src="https://www.allyproperties.pk/admin-panel/pages/project/<?php echo $show['feature_img5'] ?>" style="margin: auto; width:60px; height:60px; margin-bottom: 5px;" alt="">
<h4>
<?php echo $show['feature_title5'] ?></h4>
        </div>
        <div class="col-md-4 col-6 text-center my-4">
<img src="https://www.allyproperties.pk/admin-panel/pages/project/<?php echo $show['feature_img6'] ?>" style="margin: auto; width:60px; height:60px; margin-bottom: 5px;" alt="">
<h4>
...
<div class="col-sm-10 text-center m-auto">
    <a href="" >
        <img src="https://www.allyproperties.pk/admin-panel/pages/project/<?php echo $show['plan_image'] ?>" alt="">
    </a>
</div>
<a href="https://www.allyproperties.pk/admin-panel/pages/project/<?php echo $show['pdf'] ?>" target="_blank" >
<div  class="button">
