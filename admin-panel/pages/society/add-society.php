...
if($_SERVER["REQUEST_METHOD"] == "POST"){
 $society_title = $_POST["society_title"];
  ...
  $sql="INSERT INTO `societies`(`society_title`,`slug`,`yt_video`,`short_desc`,`feature_image`,`society_details`,`feature_title1`,`feature_img1`,`feature_title2`,`feature_img2`,`feature_title3`,`feature_img3`,`feature_title4`,`feature_img4`,`feature_title5`,`feature_img5`,`feature_title6`,`feature_img6`,`pdf`,`plan_image`,`location`,`meta_title`,`meta_desc`,`position`) VALUES ('$society_title','$slug','$yt_video','$short_desc','$dst','$society_details','$feature_title1','$dst2','$feature_title2','$dst3','$feature_title3','$dst4','$feature_title4','$dst5','$feature_title5','$dst6','$feature_title6','$dst7','$dst8','$dst9','$location','$meta_title','$meta_desc','$position')";
    ...
    <div class="layout-wrapper layout-content-navbar">
      <div class="layout-container">
       ...
       <div class="row" style="justify-content:space-between; align-items:center;"> 
        ...
        <span class="text-muted fw-light">Dashboard / Societies /</span> Add Society</h4> <button type="a" class="btn btn-primary py-3 mb-4"  style="width:fit-content; color:#fff;" type="submit" name="submit">Upload</button>
    </div>   
       <div class="card">  
        <div class="card-body"> 
<div class="row mb-4">
<div class="col-lg-6 col-md-6 col-sm-12">
    <div>
                        ...
                        <input type="text" class="form-control basic-usage" name="society_title" placeholder="Society Title" ">
...
<div class="mb-2">
                    ...
                    <div>
                        ...
                        <textarea class="form-control" id="society_details" name="society_details" rows="3" style="height: 90px;"></textarea>
                      </div>
                    </div>
              </div> 
                ...
                <div class="col-lg-6 col-md-6 col-sm-12">
                    <div class="">
                                      ...
                                      <div class="togg">
                                        ...
                                        mb-2" name="feature_title6" placeholder="Feature Title" >
