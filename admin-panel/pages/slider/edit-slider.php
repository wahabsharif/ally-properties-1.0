...
//  }
  ...
  $id=$_GET['id'];
$datashowquery="SELECT * FROM `slider` WHERE id='$id' ";
...
<div class="col-lg-6 col-md-6 col-sm-12">
   <div class="">
                                        ...
                                        <input class="form-control mb-2" type="file" name="slider_img" id="formFile" value="<?php echo $socdata['slider_img'] ?>">
                                      
                                      </div>
                                       <div class="">
                                        <label for="slider_img" class="form-label">slider Link</label>
                                      
                                        <input class="form-control mb-2" type="text" name="link" id="formFile" value="<?php echo $socdata['link'] ?>">
...
if($_SERVER["REQUEST_METHOD"] == "POST"){
 $link = $_POST["link"];
      ...
      $dst="images/".$fnm;
        ...
        $sql="UPDATE `slider` SET `slider_img`='$dst',`link`='$link'WHERE`id`='$id'";
